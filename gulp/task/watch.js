...
gulp.task('watch', () => {
    ...
    gulp.watch(configuration.path.watch.font, gulp.series('font', 'server:reload'));
    gulp.watch(configuration.path.watch.image.main, gulp.series('image:main', 'server:reload'));
    gulp.watch(configuration.path.watch.image.base64, gulp.series('image:base64'));
    ...
    gulp.watch(configuration.path.watch.script.library, gulp.series('script:library', 'server:reload'));
