...
npm run block example # создает папку блока example, с example.ts, example.pug, example.scss файлами
...
npm run prettier # проверяет форматирование .js, .pug, .scss, .svg, .ts файлов согласно Prettier и Prettier Plugins
